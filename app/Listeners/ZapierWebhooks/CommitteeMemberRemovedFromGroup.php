...
class CommitteeMemberRemovedFromGroup extends ZapierWebhookListener
{
    protected $eventSubscribeName = "CommitteeMemberRemovedFromGroup";
     ...
     * @throws \Exception
     */
    public function handle(StudentRemovedFromGroup $event)
    {
